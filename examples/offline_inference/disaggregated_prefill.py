...
def run_prefill(prefill_done):
    ...
    prompts = [
        ...
        "Tell me a very long story" * 1000,
    ]
    ...
    llm = LLM(model="LLM-Research/Meta-Llama-3.1-8B-Instruct",
...
#     ktc = KVTransferConfig.from_cli(
#         '{"kv_connector":"PyNcclConnector","kv_role":"kv_producer","kv_rank":0,"kv_parallel_size":2}')
#     model = LLM(model=model_name, kv_transfer_config=ktc,
#                 max_model_len=1024, gpu_memory_utilization=0.8)
#     model.generate(prompts, sample_parameter)
#     print("Prefill node is finished.")
#     prefill_done.set()
